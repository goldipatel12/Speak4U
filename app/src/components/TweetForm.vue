...
<template>
        ...
        <div class="flex flex-wrap items-center justify-between -m-2">
            ...
            <div class="relative m-2 mr-4">
                <input
                    type="text"
                    placeholder="topic"
                    class="text-blue-900 rounded-full pl-10 pr-4 py-2 bg-gray-100"
                    :value="effectiveTopic"
                    :disabled="forcedTopic"
                    @input="topic = $event.target.value"
                >
                <div class="absolute left-0 inset-y-0 flex pl-3 pr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 m-auto" :class="effectiveTopic ? 'text-blue-900' : 'text-gray-400'" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="flex items-center space-x-6 m-2 ml-auto">
                ...
                <button
                    ...
                    :class="canTweet ? 'bg-blue-900' : 'bg-blue-500 cursor-not-allowed'"
                    @click="send"
                >
                    Speak4U
                </button>
    ...
    <div v-else class="px-8 py-4 bg-gray-50 text-gray-500 text-center border-b">
        Connect your wallet to start Speak4U .....
    </div>
</template>
